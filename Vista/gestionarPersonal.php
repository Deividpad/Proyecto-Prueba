...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          ...
          <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header" style="color: black; "><i class="fa fa-files-o"></i>Administrar Personal</h3>
                    <ol class="breadcrumb">
                        <li><i class="fa fa-home"></i><a href="index.php">Inicio</a></li>
                        <li><i class="icon_document_alt"></i><a href="crearPersona.php"> Registrar Personal de Vuelo</a></li>
                        <li><i class="fa fa-files-o"></i>Administrar Personal</li>
                    </ol>
                </div>
            </div>
              ...
              <table  class="table table-striped table-bordered dt-responsive nowrap">
                      ...
                      echo PersonaController::gestionarPersonal(); ?>
